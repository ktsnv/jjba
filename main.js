...
function generate() {
 ...
 image("A really different and unique stand from JJBA named " + stand + " in a 2d seinen style with heavy shading. Its color scheme being: " + color + " and its power being: " + power);
}
function lineBreak() {
  const container = document.querySelector("#container");
